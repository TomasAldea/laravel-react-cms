...
namespace App\Filament\Resources\MenuWebResource\Widgets;
...
class MenuWebWidget extends BaseWidget
{
    protected static string $model = MenuWeb::class;

    protected static int $maxDepth = 2;

    protected ?string $treeTitle = 'Menú principal (ejemplo de widget)';
